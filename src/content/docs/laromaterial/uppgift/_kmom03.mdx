...
- artikeln om [Exceptions](./../Kunskap/Exception.md).
- artikeln om [Filer](./../Kunskap/File.md).
- artikeln [Sortera information](./../Kunskap/Sortering.md).
...
![Klassdiagram FileHandler](./../../../images/kmom03/classdiagramFileHandler.png "Klassdiagram FileHandler")
...
[Video på Dice100](https://youtu.be/TJc7Z614cz0)
...
Testa din kod genom att köra igenom ditt menyprogram och kontrollera att det fungera som det ska. Du har kontrollerat att testprojektet från uppgiften ovan går igenom vilket innebär att  **FileHandler**, **Exception**, **Die**, **DieGraphicTest** och **Round** fungerar som de ska. Kopiera testprojektet [**Dice100.Tests**](./../../../CodeExamples/kmom03/uppgift/Dice100.Tests) från CodeExamples/kmom03 och lägg i me/kmom03 och då ser det ut så här:
